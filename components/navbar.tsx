...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-4 left-1/4 -translate-x-1/2 z-50 w-[75%] max-w-2xl rounded-full backdrop-blur-lg bg-gradient-to-r from-purple-400/30 via-pink-400/30 to-purple-400/30 shadow-xl px-6 py-3"
    >
